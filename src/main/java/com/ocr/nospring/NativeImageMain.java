...
/**
 * Native Image Compatible Main Class
 * 
...
public class NativeImageMain {
    ...
    private static void printUsage() {
        ...
        System.out.println("========================================");
        System.out.println("  JPEG2PDF-OFD v" + VERSION);
        System.out.println("  GraalVM Native Image Edition");
        System.out.println("========================================");
        System.out.println();
        System.out.println("Features:");
        System.out.println("  - Single executable (no JRE needed)");
        System.out.println("  - Fast startup (<1s)");
        System.out.println("  - Small size (~30-50 MB)");
        System.out.println();
